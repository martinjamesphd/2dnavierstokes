...
void solve_rk2 (fftw_complex *omega_ft, fftw_complex *omega_t, fftw_complex *x_vel_ft, fftw_complex *y_vel_ft, struct coordinate *part_pos, struct coordinate *part_vel)
{
	...
	//calls update part here since x_vel and y_vel are available
	update_part(x_vel, y_vel, part_pos, part_vel);
	...
	find_jacobian_ft(omega, x_vel, y_vel);				//update jacobian_ft wrt new omega
